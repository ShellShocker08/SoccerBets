...
namespace Soccer.Web.Helpers
{
    public class MatchHelper : IMatchHelper
    {
        ...
        public async Task CloseMatchAsync(int matchId, int goalsLocal, int goalsVisitor)
        {
            ...
            _matchStatus = GetMatchStatus(_matchEntity.GoalsLocal, _matchEntity.GoalsVisitor);
        ...
        private int GetPoints(PredictionEntity predictionEntity)
        {
            ...
            if (_matchStatus == GetMatchStatus(predictionEntity.GoalsLocal.Value, predictionEntity.GoalsVisitor.Value))
            {
                points++;
            }
        ...
        private void UpdatePositions()
        {
            ...
            local.GoalsFor += _matchEntity.GoalsLocal;
            local.GoalsAgainst += _matchEntity.GoalsVisitor;
            visitor.GoalsFor += _matchEntity.GoalsVisitor;
            visitor.GoalsAgainst += _matchEntity.GoalsLocal;
