...
namespace Soccer.Web.Data
{
    public class SeedDB
    {
        ...
        private void AddTeam(string name)
        {
            ...
            {
                Name = name,
                LogoPath = $"{resourcesFolder}/Teams/{name}.jpg",
                Active = true
            });
        }
            ...
            if (!_context.Tournaments.Any())
            {
               ...
               "Static:SeederImageFolder");
                ...
                _context.Tournaments.Add(new TournamentEntity
                {
                    ...
                    EndDate = endDate,
                    IsActive = true,
                    LogoPath = $"{resourcesFolder}/Tournaments/Copa America 2020.png",
                ...
                _context.Tournaments.Add(new TournamentEntity
                {
                    ...
                    EndDate = endDate,
                    IsActive = true,
                    LogoPath = $"{resourcesFolder}/Tournaments/Liga Aguila 2020-I.png",
