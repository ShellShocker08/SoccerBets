...
namespace Soccer.Web.Controllers.API
{
    ...
    public class PredictionsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPredictionsForUser([FromBody] PredictionRequest request)
        {
